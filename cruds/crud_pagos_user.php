...
if (isset($_SESSION['user_id'])) {
    ...
    // Consultar los registros de la tabla para el usuario actual
    $stmt = $conn->prepare("SELECT libro.precio, libro.titulo, compra_descarga.tipo, compra_descarga.metodo_pago 
                            FROM compra_descarga
...
<?php
    ...
    // Si no hay sesión activa, redirigir al usuario a iniciar sesión
